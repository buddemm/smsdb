                            ...
                            if ($template->is_division) {
                                ...
                                <tr>
                                    <td valign="top" colspan="5" width="20%" style="font-weight: normal; text-align: left; border-top:0;padding-top: 5px;">
                                        ...
                                        <span style="border-left:0;text-align: left;font-weight: bold; padding-left: 30px;">
                                            <?php
                                            if ($percentage_total >= 75) {
                                                echo $this->lang->line('first');
                                            } elseif ($percentage_total >= 65 && $percentage_total <= 74) {
                                                echo $this->lang->line('second');
                                            } elseif ($percentage_total >= 45 && $percentage_total <= 64) {
                                                echo $this->lang->line('third');
											} elseif ($percentage_total >= 30 && $percentage_total <= 44) {
                                                echo $this->lang->line('four');
											} elseif ($percentage_total >= 0 && $percentage_total <= 29) {
                                                echo $this->lang->line('zero');
                                            } else {
                            ...
                            <td valign="top" style="padding-top: 10px;">
                                ...
                                if (!empty($student_value['exam_result'])) {
                                    ...
                                    <span style="border-left:0;text-align: left;font-weight: bold; padding-left: 30px;">
                                        ...
                                        if ($consolidate_percentage_total >= 75) {
                                            echo $this->lang->line('first');
                                        } elseif ($consolidate_percentage_total >= 65 && $consolidate_percentage_total <= 74) {
                                            echo $this->lang->line('second');
