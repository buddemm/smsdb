...
if ($this->rbac->hasPrivilege('general_setting', 'can_view')) {
        ...
        if ($this->rbac->hasPrivilege('system_fields', 'can_view')) {
          ...
          if ($this->rbac->hasPrivilege('online_admission', 'can_view')) {
        ?>
                                <li class=""><a href="<?php echo base_url(); ?>admin/onlineadmission/admissionsetting"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('online_admission_setting') ?></a></li>
                                    <?php
  }
